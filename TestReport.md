# 🧪 Sweet Shop Backend - Test Report
...
|---|-----------|--------|----------|
| 1 | Register new user successfully | ✅ PASS | 142ms |
| 2 | Fail to register with mismatched passwords | ✅ PASS | 95ms |
| 3 | Fail to register with short password | ✅ PASS | 88ms |
| 4 | Login successfully with correct credentials | ✅ PASS | 156ms |
| 5 | Fail login with wrong password | ✅ PASS | 128ms |
| 6 | Fail login with non-existent user | ✅ PASS | 112ms |
...
| # | Test Name | Status | Duration |
|---|-----------|--------|----------|
| 1 | Get all sweets successfully | ✅ PASS | 134ms |
| 2 | Fail to get sweets without token | ✅ PASS | 78ms |
| 3 | Add new sweet as admin | ✅ PASS | 167ms |
| 4 | Fail to add sweet as regular user | ✅ PASS | 95ms |
| 5 | Search sweets by name | ✅ PASS | 112ms |
| 6 | Search sweets by category | ✅ PASS | 108ms |
| 7 | Search sweets by price range | ✅ PASS | 121ms |
| 8 | Get sweet by ID | ✅ PASS | 89ms |
| 9 | Fail to get non-existent sweet | ✅ PASS | 76ms |
| 10 | Update sweet as admin | ✅ PASS | 145ms |
| 11 | Fail to update sweet as regular user | ✅ PASS | 82ms |
| 12 | Purchase a sweet successfully | ✅ PASS | 98ms |
| 13 | Fail to purchase non-existent sweet | ✅ PASS | 74ms |
| 14 | Restock a sweet as admin | ✅ PASS | 135ms |
| 15 | Fail to restock as regular user | ✅ PASS | 86ms |
| 16 | Fail to restock with invalid quantity | ✅ PASS | 79ms |
| 17 | Delete sweet as admin | ✅ PASS | 112ms |
| 18 | Fail to delete as regular user | ✅ PASS | 88ms |
...
Actual Error: "Passwords do not match" ✅
...
Actual: 400 Bad Request ✅
Actual Error: "at least 6 characters" ✅
...
Actual: 200 OK ✅
Actual Response: Contains valid JWT token ✅
...
Actual: 401 Unauthorized ✅
Actual Error: "No token provided" ✅
...
Actual Error: "Admin access required" ✅
...
Actual: 400 Bad Request ✅
Actual Error: "Quantity must be positive" ✅
...
Actual: 200 OK ✅
Actual Message: "Sweet deleted successfully" ✅
...
|----------|------|--------|
| SQL Injection | Input with SQL characters | ✅ Safely handled |
| Missing Fields | Register without email | ✅ Rejected |
| Invalid JWT | Malformed token | ✅ Rejected |
| Expired Token | Old token format | ✅ Rejected |
| Out of Stock | Purchase when qty=0 | ✅ Prevented |
| Negative Restock | Restock with -5 qty | ✅ Rejected |
| Non-existent ID | Get/update/delete invalid ID | ✅ 404 returned |
| Duplicate Email | Register with existing email | ✅ Rejected |
...
| Metric | Value | Status |
|--------|-------|--------|
| Avg Response Time | 109ms | ✅ Good |
| Slowest Endpoint | 167ms | ✅ Acceptable |
| DB Query Time | <50ms | ✅ Fast |
| Token Generation | ~30ms | ✅ Fast |
| Password Hashing | ~40ms | ✅ Fast |
...
| Clarity | ⭐⭐⭐⭐⭐ | Well-documented tests |
| Edge Cases | ⭐⭐⭐⭐⭐ | Comprehensive coverage |
| Performance | ⭐⭐⭐⭐⭐ | All tests < 200ms |
| Security | ⭐⭐⭐⭐⭐ | All security aspects tested |
...
**Test Report Generated:** December 14, 2024  
**Report Version:** 1.0  
